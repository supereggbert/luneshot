...
export default class Sky{
    constructor( renderer, scene ){
        ...
        this.elevation = 0.7;
        this.direction = 0.33;
        this.cloudCover = 0.75;
        this.cloudThickness = 0.1;
        ...
        dirLight.position.copy( this.sunDirection ).multiplyScalar(-1000);
    ...
    updateSunDirection(){
        ...
        this.sunLight.intensity = lightIntensity * Math.pow(Math.max(0,this.sunDirection.y),0.2) * 0.75 * 5;
